...
namespace Lot.Web
{
    public class SwaggerConfiguration
    {
        ...
        /// </summary>
        public const string EndpointDescription = "Lot Api v1";
        ...
        /// <para>Foo API</para>
        /// </summary>
        public const string DocInfoTitle = "Lot API";
        ...
        /// </summary>
        public const string DocInfoDescription = "Lot Api - Lot Web API in ASP.NET Core 2";
